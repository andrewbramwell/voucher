...
banner:
  ...
  description: พลิกโฉมการขายบัตรกำนัลด้วย Voucherstore ระบบบริหารบัตรกำนัล บัตรของขวัญคูปอง
    อิเล็กทรอนิกส์ มาตรฐานสากล และมีความปลอดภัยสูง
  button:
    enable: true
...
image_and_content_block_0:
  enable: true
  subtitle: ''
  title: ซอฟต์แวร์บริหารบัตรกำนัล บัตรของขวัญ และคูปอง ระบบอิเล็กทรอนิกส์
